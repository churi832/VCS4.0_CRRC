...
namespace Sineva.VHL.Task
{
    ...
    public class SeqFrontDetectInterlock : XSeqFunc
    {
        ...
        public SeqFrontDetectInterlock()
        {
            ...
            m_ALM_AbnormalFrontDetectInterlock = AlarmListProvider.Instance.NewAlarm(AlarmCode.IrrecoverableError, true, "INTERLOCK", "LOWER OBS", "Abnormal Detect Interlock Alarm");
